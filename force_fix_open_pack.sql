-- Script de correction FORCÉE de la fonction open_pack
-- Supprime TOUTES les versions et recrée une version unique et simple

-- ========================================
-- ÉTAPE 1: Supprimer TOUTES les versions possibles
-- ========================================

-- Supprimer toutes les fonctions open_pack existantes (toutes les signatures possibles)
...
-- Supprimer aussi avec CASCADE pour être sûr
DROP FUNCTION IF EXISTS open_pack CASCADE;
...
-- ========================================
-- ÉTAPE 3: Créer une fonction open_pack SIMPLE et CORRECTE
-- ========================================
...
BEGIN
    ...
    -- Retourner les cartes générées avec des noms de colonnes explicites
    RETURN QUERY SELECT 
        t.card_id as id,
        t.card_name as name,

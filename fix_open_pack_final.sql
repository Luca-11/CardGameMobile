-- Script final pour corriger la fonction open_pack
-- Problème : Ambiguïté sur la colonne "id" et conflits entre plusieurs versions
...
-- ========================================
-- ÉTAPE 3: Créer la nouvelle fonction open_pack corrigée
-- ========================================

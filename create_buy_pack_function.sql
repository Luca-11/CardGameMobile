-- Script pour créer la fonction buy_pack manquante
-- Cette fonction est nécessaire pour l'achat de packs
...
-- Créer aussi la fonction open_pack qui sera nécessaire pour ouvrir les packs
